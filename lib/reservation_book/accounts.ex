defmodule ReservationBook.Accounts do
  ...
  alias ReservationBook.Accounts.{User, UserToken, UserNotifier}
  ...
  @doc """
  Updates the data in the user, provided that the password is ok and it passes validation.

  ## Examples

      iex> apply_user_update(user, "valid password", %{email: ...})
      {:ok, %User{}}

      iex> apply_user_update(user, "invalid password", %{email: ...})
      {:error, %Ecto.Changeset{}}
