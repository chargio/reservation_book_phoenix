defmodule ReservationBookWeb.UserAuthTest do
  ...
  @remember_me_cookie "_reservation_book_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ReservationBookWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ReservationBookWeb.Endpoint.subscribe(live_socket_id)
